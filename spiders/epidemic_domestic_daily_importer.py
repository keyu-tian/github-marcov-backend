...
def epidemic_domestic_daily_importer():
    # daily_data = json.load(open('/Users/lucien/Downloads/multi_history_get.json', 'r', encoding='utf-8'))
    ...
    provinces = json.load(open('/Users/lucien/dev/backend/gitee-marcov-backend/spiders_data/epidemic_domestic_data'
                               '/province.json', 'r', encoding='utf-8'))
    ...
    for province in province_dict_ch.keys():
        if province in yesterday_provinces_data.keys():
            cal_add = today_provinces_data[province]['total']['confirm'] - yesterday_provinces_data[province]['total']['confirmed']
...
if __name__ == '__main__':
    epidemic_domestic_daily_importer()
