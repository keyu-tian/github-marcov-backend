...
re_country_vaacinations_dict = {'葡萄牙': 'Portugal', '保加利亚': 'Bulgaria', '多哥': 'Togo', '印度': 'India', '阿尔巴尼亚': 'Albania',
                                '科威特': 'Kuwait', '挪威': 'Norway', '吉尔吉斯斯坦': 'Kyrgyzstan', '喀麦隆': 'Cameroon',
                                '日本': 'Japan', '塔吉克斯坦': 'Tajikistan', '白俄罗斯': 'Belarus', '赞比亚': 'Zambia',
                                '卡塔尔': 'Qatar', '萨尔瓦多': 'El Salvador', '约旦': 'Jordan', '爱沙尼亚': 'Estonia', '马里': 'Mali',
                                '马拉维': 'Malawi', '阿尔及利亚': 'Algeria', '尼加拉瓜': 'Nicaragua', '阿富汗': 'Afghanistan',
                                '贝宁': 'Benin', '沙特阿拉伯': 'Saudi Arabia', '瓦努阿图': 'Vanuatu', '毛里塔尼亚': 'Mauritania',
                                '苏丹': 'Sudan', '冰岛': 'Iceland', '泰国': 'Thailand', '巴勒斯坦': 'Palestine', '乌拉圭': 'Uruguay',
                                '几内亚': 'Guinea', '也门': 'Yemen', '缅甸': 'Myanmar', '奥地利': 'Austria',
                                '英国': 'United Kingdom', '巴拿马': 'Panama', '比利时': 'Belgium', '危地马拉': 'Guatemala',
                                '加纳': 'Ghana', '埃及': 'Egypt', '马来西亚': 'Malaysia', '特里尼达和多巴哥': 'Trinidad and Tobago',
                                '西班牙': 'Spain', '新喀里多尼亚': 'New Caledonia', '圭亚那': 'Guyana', '柬埔寨': 'Cambodia',
                                '布基纳法索': 'Burkina Faso', '斯洛文尼亚': 'Slovenia', '塞浦路斯': 'Cyprus', '拉脱维亚': 'Latvia',
                                '阿塞拜疆': 'Azerbaijan', '肯尼亚': 'Kenya', '利比里亚': 'Liberia', '亚美尼亚': 'Armenia',
                                '匈牙利': 'Hungary', '塞拉利昂': 'Sierra Leone', '格陵兰': 'Greenland', '智利': 'Chile',
                                '南非': 'South Africa', '芬兰': 'Finland', '斯里兰卡': 'Sri Lanka', '哥斯达黎加': 'Costa Rica',
                                '巴布亚新几内亚': 'Papua New Guinea', '乌干达': 'Uganda', '立陶宛': 'Lithuania', '荷兰': 'Netherlands',
                                '哥伦比亚': 'Colombia', '不丹': 'Bhutan', '阿曼': 'Oman', '塞尔维亚': 'Serbia', '卢旺达': 'Rwanda',
                                '黑山': 'Montenegro', '厄瓜多尔': 'Ecuador', '科索沃': 'Kosovo', '委内瑞拉': 'Venezuela',
                                '安哥拉': 'Angola', '埃塞俄比亚': 'Ethiopia', '希腊': 'Greece', '波兰': 'Poland', '叙利亚': 'Syria',
                                '苏里南': 'Suriname', '蒙古': 'Mongolia', '加拿大': 'Canada', '加蓬': 'Gabon', '尼日尔': 'Niger',
                                '丹麦': 'Denmark', '罗马尼亚': 'Romania', '孟加拉国': 'Bangladesh', '意大利': 'Italy',
                                '菲律宾': 'Philippines', '澳大利亚': 'Australia', '利比亚': 'Libya', '索马里': 'Somalia',
                                '德国': 'Germany', '巴基斯坦': 'Pakistan', '吉布提': 'Djibouti', '乍得': 'Chad',
                                '津巴布韦': 'Zimbabwe', '刚果': 'Congo', '塞内加尔': 'Senegal', '巴西': 'Brazil', '古巴': 'Cuba',
                                '冈比亚': 'Gambia', '法国': 'France', '越南': 'Vietnam', '伊朗': 'Iran', '马达加斯加': 'Madagascar',
                                '以色列': 'Israel', '土库曼斯坦': 'Turkmenistan', '尼日利亚': 'Nigeria', '美国': 'United States',
                                '新西兰': 'New Zealand', '巴哈马': 'Bahamas', '摩尔多瓦': 'Moldova',
                                '阿联酋': 'United Arab Emirates', '洪都拉斯': 'Honduras', '文莱': 'Brunei', '尼泊尔': 'Nepal',
                                '阿根廷': 'Argentina', '格鲁吉亚': 'Georgia', '玻利维亚': 'Bolivia', '突尼斯': 'Tunisia',
                                '瑞士': 'Switzerland', '莫桑比克': 'Mozambique', '博茨瓦纳': 'Botswana', '中国': 'China',
                                '几内亚比绍': 'Guinea-Bissau', '卢森堡': 'Luxembourg', '瑞典': 'Sweden', '斯洛伐克': 'Slovakia',
                                '福克兰群岛': 'Falkland Islands', '莱索托': 'Lesotho', '哈萨克斯坦': 'Kazakhstan',
                                '印度尼西亚, 印尼': 'Indonesia', '秘鲁': 'Peru', '俄罗斯': 'Russia', '纳米比亚': 'Namibia',
                                '巴拉圭': 'Paraguay', '斐济': 'Fiji', '伯利兹': 'Belize', '墨西哥': 'Mexico', '牙买加': 'Jamaica',
                                '黎巴嫩': 'Lebanon', '摩洛哥': 'Morocco', '爱尔兰': 'Ireland', '乌兹别克斯坦': 'Uzbekistan',
                                '百慕大': 'Bermuda', '克罗地亚': 'Croatia', '土耳其': 'Turkey', '伊拉克': 'Iraq', '乌克兰': 'Ukraine'}
