...
_rich_greet = OrderedDict({
    '我是小嘤🌸，可解答疫情数据统计、新闻、政策等问题，请问有什么问题吗': 1,
    '我是小嘤🌸，可解答疫情数据统计、新闻、政策等问题，您有什么疑惑吗': 1,
    '我是小嘤🌸，可解答疫情数据统计、新闻、政策等问题，您有任何问题都可以问我': 1,
    '我是小嘤🌸，可解答疫情数据统计、新闻、政策等问题，很乐意为您答疑解惑！': 1,
    '我是小嘤🌸，可解答疫情数据统计、新闻、政策等问题，有什么我可以帮您': 1,
    '我是小嘤🌸，可解答疫情数据统计、新闻、政策等问题，有什么我可以解惑的吗': 1,
    '我是小嘤🌸，可解答疫情数据统计、新闻、政策等问题，有什么问题问我就好。': 1,
    '我是小嘤🌸，可解答疫情数据统计、新闻、政策等问题，您可以问我疫情问题，或者和我聊天哦。': 1,
    '我是小嘤🌸，可解答疫情数据统计、新闻、政策等问题，问我疫情相关问题或者聊天都可以的哦~': 1,
    '我是小嘤🌸，可解答疫情数据统计、新闻、政策等问题，您有任何问题，都可以问我这个小机灵鬼哦~': 1,
    '我是小嘤🌸，可解答疫情数据统计、新闻、政策等问题，您有任何问题，都可以问我这个小机灵鬼儿哦~': 1,
    '我是小嘤🌸，可解答疫情数据统计、新闻、政策等问题，等您消息等好久了，快来问我吧~': 2,
    '我是小嘤🌸，可解答疫情数据统计、新闻、政策等问题，等亲消息等到荷花都要谢了，有什么问题快来问我吧~': 2,
})
